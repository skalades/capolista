...
const MENU_SECTIONS = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: 'Dikirim', routeName: 'gudang.dikirim.index', icon: Truck, levels: [0, 1, 2, 3, 4], divisi: ['gudang'] },
            { name: 'Gudang & Stok', routeName: 'gudang.stok', icon: Warehouse, levels: [0, 1, 2, 3, 4], divisi: ['gudang'] },
