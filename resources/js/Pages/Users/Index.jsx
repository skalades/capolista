        ...
        <AppLayout 
            ...
            headerActions={
                <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-md bg-navy px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-navy/90"
                >
            ...
            <Card className="mb-6">
                <div className="flex gap-4 items-center">
                    ...
                    <select
                        ...
                        className="block w-48 rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-navy sm:text-sm sm:leading-6"
                    >
