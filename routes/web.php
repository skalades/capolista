...
Route::middleware(['auth', 'verified', 'active'])->group(function () {
    ...
    Route::middleware('level:0,1,2')->group(function () {
        ...
        Route::post('/orders/bulk-merge', [OrderController::class, 'bulkMerge'])->name('orders.bulk-merge');
    ...
    Route::prefix('keuangan')->name('keuangan.')->middleware(['level:0,1,2,3,4', 'divisi:keuangan'])->group(function () {
        ...
        Route::get('/api/analitik', [KeuanganController::class, 'apiAnalitik'])->name('api.analitik');
